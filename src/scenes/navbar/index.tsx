...
const Navbar = ({ isTopOfPage, selectedPage, setSelectedPage }: Props) => {
  ...
  const navbarBackground = isTopOfPage ? "" : "bg-customBlue drop-shadow";
    ...
    <nav>
        ...
        <div className={`${flexBetween} mx-auto w-5/6`}>
          <div className={`${flexBetween} w-full gap-16`}>
            {isAboveMediumScreens ? (
              ...
              <button
                className="rounded-full bg-customBlue p-5"
      ...
      {!isAboveMediumScreens && isMenuToggled && (
        <motion.div  
          ...
          className="fixed right-0 top-0 z-40 h-full w-[300px] bg-customBlue drop-shadow-xl">
