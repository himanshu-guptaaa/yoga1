...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 py-10 sl:py-6 bg-blue">
      <motion.div
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          <motion.div
            ...
            <div className="relative">
              <div className=" text-blue-500 text-4xl md:text-6xl font-boldbefore:absolute before:-top-[140px] before:-left-20 before:z-[-1] md:before:content-evolvetext">
              योगश्चित्तवृत्तिनिरोधः।
              </div>
            </div>
            <p className="mt-4 text-base">
            “Yoga is calming the mind and stopping its restless thoughts.

It teaches focus, peace, and self-awareness.“
            </p>
          </motion.div>
          <motion.div
